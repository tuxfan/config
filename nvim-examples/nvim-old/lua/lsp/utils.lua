...
-- This function defines the on_attach function for several languages
-- that share the same key-bidings
function M.common_on_attach(client, bufnr)
  ...
  -- Keymaps: we need to define keymaps for each of the LSP functionalities
  -- manually. Go to definition and declaration (use leader to presever
  -- standard use of 'gd')
  ...
  -- Uses quickfix
  -- bufnnoremap("<leader>gr", "<cmd>lua vim.lsp.buf.references()<CR>")

  -- Uses Telescope
  bufnnoremap("<leader>gr", "<cmd>Telescope lsp_references<CR>")
